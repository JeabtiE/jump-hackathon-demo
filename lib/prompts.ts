...
4. ช่อง goalRef ใส่รหัสเป้าหมายที่สื่อนั้นสนับสนุนหลัก ๆ (เช่น "goal_1") **ถ้าระบุไม่ได้ให้เว้นว่าง**
   ไม่ต้องฝืนจับคู่ — สื่อที่เป็นวัสดุประกอบหรือใช้กับทั้งแผนไม่ต้องมี goalRef
...
ตอบเป็น JSON เท่านั้น ไม่ต้องมีข้อความอื่นนอก JSON:
{
  ...
  "mediaRecommendations": [
    { "code": "รหัสในวงเล็บเหลี่ยมที่ระบบส่งให้ เช่น BE1784", "item": "ชื่อสื่อตรงตามที่ระบบส่งให้", "goalRef": "goal_1", "reason": "เหตุผลที่เชื่อมโยงกับเป้าหมาย IEP ข้างต้น" }
  ]
}
