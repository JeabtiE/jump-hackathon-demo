...
แล้วเลือกว่าตรงกับ "ระดับ" ใดมากที่สุด จากรายการปิดด้านล่างนี้เท่านั้น

ตัวเลือกที่เลือกได้ (ห้ามสร้างค่าใหม่นอกเหนือจากนี้):
${optionLines}

กฎ:
1. เลือก value ได้เพียงหนึ่งค่าจากรายการข้างบนเท่านั้น หรือคืน null ถ้าไม่มีค่าใดตรง หรือข้อความกำกวมเกินจะตัดสิน
2. ห้ามเดา ห้ามสร้าง value ใหม่ ห้ามเลือกค่าที่ใกล้เคียงถ้าไม่มั่นใจ — ความปลอดภัยสำคัญกว่าการตอบให้ได้
3. confidence = "high" เมื่อข้อความชี้ชัดตรงกับ label ค่านั้น, = "low" เมื่อคลุมเครือ ตีความได้หลายทาง หรือข้อมูลไม่พอ
