 ...
 * วิชาที่เปิดใช้จริง
 *
 * ✅ "math" เปิดใช้จริงแล้ว — ข้อความผ่านการตรวจอัตโนมัติ (9 ส.ค. 2569)
 *
 ...
 *
 *    ตรวจด้วย npm run verify:math — เทียบก่อน/หลังจาก git history ตรงๆ
 *    109/109 รายการที่แก้ ผ่านครบ 4 ข้อ (ความยาวเท่าเดิม / ลำดับตัวเลขเท่าเดิม /
 *    ทุกตำแหน่งที่ต่างเป็น ำ↔า เท่านั้น / ทุก "ำ" ที่เหลืออธิบายได้ด้วยตาราง RESTORE)
 *    strandText 27/27 ผ่าน ภาษาไทยและรหัสตัวชี้วัดไม่ถูกแตะ
 *    ตัว verifier เองก็พิสูจน์แล้วว่าจับของเสียได้จริง (fixture จงใจทำพัง 4 แบบ จับครบ)
 *
 *    ⚠️ สิ่งที่การตรวจนี้ไม่ครอบคลุม — มันพิสูจน์ว่า "การซ่อมไม่ได้ทำอะไรพัง"
 *    ไม่ได้พิสูจน์ว่า "สะกดถูกตามหลักภาษาไทยทุกคำ" ถ้ามีคำที่ควรเป็น "ำ"
 *    แต่ไม่มี entry ในตาราง RESTORE คำนั้นจะออกมาเป็น "า" แล้วผ่านทุกข้อ
 *    เพราะมันคือผลลัพธ์ที่ตารางกำหนดไว้จริงๆ
 *
 *    ถ้าครูเจอคำผิดตอนใช้จริง: แก้ตาราง RESTORE ในสคริปต์แล้วรันใหม่
 *    อย่าแก้ data/curriculum.json ด้วยมือ เพราะสคริปต์จะเขียนทับ
 *    rollback: ลบ "math" ออกจาก array นี้ — บรรทัดเดียว ภาษาไทยทำงานต่อได้ปกติ
 */
