...
export default function HomeClient({ authSlot }: { authSlot: React.ReactNode }) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <header className="mb-8 flex items-start justify-between">
        ...
        {/* มุมขวาบน: ลิงก์เดิม + แถบผู้ใช้/ปุ่มออกจากระบบ (ส่งมาจาก page.tsx ฝั่ง server) */}
      ...
      <footer className="mt-12 border-t border-slate-200 pt-4 text-xs text-slate-400">
        ...
        อยู่ระหว่างการพัฒนา
        กรุณายังไม่กรอกข้อมูลนักเรียนจริงจนกว่าจะได้รับอนุญาตจากสถานศึกษา
